...
box_g = 25                # width of each rectangle
...
b1 = Button(f,text='choose Destination',fg = 'black',bg = 'green yellow',font = '30',padx=10,command=chose_dest)
b1.grid(row=0,column=0)
b2 = Button(f,text='Barriers',fg = 'black',bg = 'green yellow',font = '30',padx=10,command=Barri)
b2.grid(row=0,column=1)
b3 = Button(f,text='shortest',fg = 'black',bg = 'green yellow',font = '30',padx=10,command=search)
